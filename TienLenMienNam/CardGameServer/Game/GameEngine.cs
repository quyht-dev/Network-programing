...
namespace CardGameServer.Game
{
    public sealed class GameEngine
    {
        ...
        public void OnDisconnected(PlayerSession session)
        {
        ...
        public void HandleMessage(PlayerSession session, NetMessage msg)
        {
        ...
        private void HandleJoin(PlayerSession session, NetMessage msg)
        {
        ...
        private void HandleReady(PlayerSession session, NetMessage msg)
        {
        ...
        private void HandlePlay(PlayerSession session, NetMessage msg)
        {
            if (string.IsNullOrWhiteSpace(session.RoomId))
            {
                session.SendError("NOT_IN_ROOM", "Join a room first.");
        ...
        private void HandlePass(PlayerSession session)
        {
            if (string.IsNullOrWhiteSpace(session.RoomId))
            {
                session.SendError("NOT_IN_ROOM", "Join a room first.");
        ...
        private void HandleChat(PlayerSession session, NetMessage msg)
        {
            if (string.IsNullOrWhiteSpace(session.RoomId))
            {
                session.SendError("NOT_IN_ROOM", "Join a room first.");
        ...
        private void SendRoomStateToPlayer(GameRoom room, PlayerSession player)
        {
